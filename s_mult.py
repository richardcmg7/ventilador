...
class serialPlot:
    def __init__(self, serialPort='/dev/ttyUSB0', serialBaud=38400, plotLength=100, dataNumBytes=2, numPlots=1):
        ...
        try:
            ...
            print('Conectado a' + str(serialPort) + ' en ' + str(serialBaud) + ' BAUD.')
        except:
            print("Fallo al conectar con " + str(serialPort) + ' en ' + str(serialBaud) + ' BAUD.')
...
def makeFigure(xLimit, yLimit, title):
    ...
    ax.set_ylabel("Salida Ventilador")
    return fig, ax
